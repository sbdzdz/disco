...
srun --gres=gpu:1 python $HOME/codis/codis/train.py wandb.group=continual_classification trainer.max_epochs=5 model=stn \
 dataset.tasks=510 dataset.factor_resolution=8 dataset.shapes_per_task=10 $additional_args