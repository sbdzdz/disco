...
python $HOME/codis/codis/train.py --wandb_dir $WORK/projects/codis/wandb --beta 1.5 --gamma 0.99 --tasks 10 --log_every_n_steps 10 --wandb_group continual_dsprites --max_epochs 50 --num_workers 16 --experiment codis --img_size 128 --batch_size 128