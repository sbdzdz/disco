...
srun --gres=gpu:1 python $HOME/codis/codis/train.py wandb.group=continual_classification trainer.max_epochs=3 model=stn \
 dataset.tasks=200 model.gamma=1.0 dataset.factor_resolution=10 dataset.shapes_per_task=10 dataset.train_split=98000 dataset.val_split=1000 dataset.test_split=1000 \
 $additional_args