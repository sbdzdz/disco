...
srun --gres=gpu:1 python $HOME/codis/codis/train.py --wandb_dir $WORK/projects/codis/wandb --beta 1.1 --gamma 0.99 --tasks 10 --log_every_n_steps 5 --wandb_group continual_dsprites --max_epochs 10 --num_workers 16 --img_size 128 --batch_size 256 --factor_resolution 16