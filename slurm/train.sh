...
python $HOME/codis/codis/train.py --wandb_dir $WORK/projects/codis/wandb --beta 1.5 --tasks 1 --log_every_n_steps 50 --wandb_group continual_dsprites --epochs 30 --num_workers 16 --experiment codis --img_size 128 --batch_size 512