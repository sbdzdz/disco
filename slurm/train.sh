...
srun --gres=gpu:1 python $HOME/codis/codis/train.py --wandb_dir $WORK/projects/codis/wandb \
dataset.tasks=16 dataset.factor_resolution=16 wandb.group=stn training.max_epochs=5 model=stn model.gamma=0.5